...
Definition test_evaluate candidate :=
  ...
  && (eqb_expressible_value (candidate (Times (Literal 5) (Literal 3))) (Expressible_nat 15))
  && (eqb_expressible_value (candidate (Plus (Literal 3) (Minus (Literal 5) (Literal 8)))) (Expressible_msg "numerical underflow: -3"))
  && (eqb_expressible_value (candidate (Plus (Minus (Literal 5) (Literal 8)) (Literal 3))) (Expressible_msg "numerical underflow: -3")).
...
Definition test_compile_aux (candidate : arithmetic_expression -> list byte_code_instruction) : bool :=
...
Definition test_compile_alt (candidate : source_program -> target_program) :=
  test_compile_aux (fun ae => match candidate (Source_program ae) with
                              | Target_program bcis => bcis
                              end).
...
Proposition about_plus_assocuiativity :
