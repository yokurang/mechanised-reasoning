...
otherwise, the title is informative

be in control of the line break(s) in your titles (and in your quotes):
they should be grammatically logical, not random

the photo is suitably geeky

-----

S1

The introduction is staying at the surface of things:

* intricacies?

* the revisitation is actually a revisitation of observational equivalence in the source language.

Split the section into two paragraphs, since there are two topics.

And be more precise in your narrative (you "did" a custom(?) arithmetic expression language?).
...
What is the relevance of the quote here?

S2.1

"Let us return to Plus and how it behaves when it is \texttt{evaluate}d."
Don Knuth, in his advice about writing, recommends not to mix what you are describing and how you are describing.
So "\texttt{evaluate}d" should be "evaluated" (and this point applies everywhere in the report).
Also, for consistency, "Plus" should be "\texttt{Plus}".

"the same message is thrown,"
-> [nothing is thrown]
"the same message is returned,"

Again, the introduction is staying at the surface of things:
The issue here is that evaluation goes from left to right.

S2.2

the title is incomplete: "of \texttt{Plus}" is missing at the end

The last sentence of 2.2 is incomplete, since it is about the other proposition.
