    ...
    + rewrite -> fold_unfold_fetch_decode_execute_loop_rtl_cons.
      ...
      * case (fetch_decode_execute_loop_rtl bci2s' (n :: ds)) as [ ds3 mh2 | s ] eqn:H_run_bcis_ds3.
        -- rewrite -> fold_unfold_list_length_cons.
           ...
           --- rewrite <- H_mh2.
               Search (_ <= S _).
               Check (Nat.le_succ_diag_r h1).
               exact (Nat.le_succ_diag_r h1).
           --- rewrite <- H_mh2.
               
             Search ( S(Nat.max _ _)).
               rewrite -> Nat.max_l in H_mh2.
               ---- 
                    admit.
               ---- 
                 admit.
      -- intro H_absurd.
           discriminate H_absurd.
      * case ds as [ | ds' ds''] eqn:H_ds.
        -- intro H_absurd.
           discriminate H_absurd.
        -- case ds'' as [ | ds'''] eqn:H_ds'.
           --- intro H_absurd.
               discriminate H_absurd.
           --- admit.
      * case ds as [ | ds' ds''] eqn:H_ds.
  ...
  - intros bci2s ds.
    ...
    -- intros ds1 h1 H_OK'_ds.
       ...
       --- intros ds2 h2 H_OK'_ds2.
           ...
           Check (about_fde_loop_stepping').
           rewrite -> (fold_unfold_list_append_nil byte_code_instruction bci2s).
           case bci2s as [ | bci2 bci2s'].
           +++ rewrite -> fold_unfold_fetch_decode_execute_loop_rtl_nil.
               rewrite -> fold_unfold_fetch_decode_execute_loop_rtl_nil in H_OK'_ds.
               rewrite -> fold_unfold_fetch_decode_execute_loop_rtl_nil in H_OK'_ds2.
               injection H_OK'_ds2 as H_ds2 H_h2.
               rewrite <- H_h1.
               rewrite <- H_h2.
               rewrite -> Nat.max_id.
               rewrite -> H_ds2.
               reflexivity.
           +++ destruct (about_fde_loop_stepping bci2 bci2s' ds ds2 h2
                           H_OK'_ds2) as [ds' [mh' [H_de [H_fdel H_h2 ]]]].
               rewrite -> H_h2.
               rewrite -> H_h2 in H_OK'_ds2.
               rewrite <- H_h1.
               rewrite -> Nat.max_assoc.
               rewrite -> Nat.max_id.
               exact H_OK'_ds2.
  ...
  - split.
    ...
    + rewrite -> (fold_unfold_depth_right_Plus ae1 ae2).
      ...
      ++ rewrite -> (fold_unfold_evaluate_rtl_Plus ae1 ae2) in H_ae.
         ...
         Check (H_eureka'' (n1 + n2 :: ds) (Nat.max (list_length nat (n1 + n2 :: ds)) (list_length nat (n1 + n2 :: ds)))).
         Check H_eureka''.
         (*
         Check Nat.max_id.
